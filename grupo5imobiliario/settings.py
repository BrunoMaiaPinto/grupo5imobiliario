"""
Django settings for grupo5imobiliario project.
...
SECRET_KEY = 'django-insecure-bhkx$gtfe%3pqqxo6j#15xdfcd96u68^8n@rg6(0n^$=%_+!%0'
...
ROOT_URLCONF = 'grupo5imobiliario.urls'
...
WSGI_APPLICATION = 'grupo5imobiliario.wsgi.application'
